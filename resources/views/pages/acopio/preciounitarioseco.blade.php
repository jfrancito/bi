@extends('layouts.app')
@section('title', 'Precio Unitario Seco')
@section('page-title', 'Precio Unitario Seco')
@section('breadcrumb')
    <div class="breadcrumb-card mb-25 d-md-flex align-items-center justify-content-between">
        <h5 class="mb-0">Precio Unitario Seco</h5>
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 mt-4">
                <h5 class="text-secondary fw-bold mb-0">
                    ...
                    Resumen Diario por Variedad (Seco)
                </h5>
                <button id="btn-export-pu-seco" class="btn btn-success btn-sm shadow-sm">
            ...
            <div class="table-responsive table-container-horizontal">
                <table id="tbl-pu-seco" class="table table-bordered align-middle">
                    <thead>
                        <tr id="header-days">
                            <!-- Injected by JS -->
                        </tr>
            ...
            <div class="mt-3">
                <small class="text-muted">
                    <span class="badge bg-success-transparent text-dark border me-2">P.U. Seco</span> Precio Unitario Seco Promedio
                    (Importe / Peso Seco)
                    <span class="badge bg-secondary-transparent text-dark border me-2">Min</span> Precio Mínimo Seco (CPUS)
                    <span class="badge bg-secondary-transparent text-dark border">Max</span> Precio Máximo Seco (CPUS)
                </small>
            </div>
...
@push('scripts')
    <script src="{{ asset('assets/js/reporte/preciounitarioseco.js?v=' . ($version ?? '1')) }}"
