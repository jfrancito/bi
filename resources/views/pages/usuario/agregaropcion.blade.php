			...
			<div class="col-md-12">
				...
				<div class="panel panel-default panel-border-color panel-border-color-primary">
					...
					<div class="panel-body">
						...
						<form method="POST" action="{{ url('/agregar-opcion/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							@if(isset($registro))
								@include('inputs.cargarmultimediamodificar')
							@else
								@include('inputs.cargarmultimedia')
							@endif
