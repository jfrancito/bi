...
@section('content')
    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            ...
            <form action="{{ url('/agregar-usuario/' . $idopcion) }}" id='frmregistrarusuarios' method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input name="nombre" type="text" id='nombre' value="" class="form-control h-55" placeholder="Nombre"
                            required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input name="name" type="text" id='name' value="" class="form-control h-55" placeholder="Usuario"
                            required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <label class="label text-secondary">Clave</label>
