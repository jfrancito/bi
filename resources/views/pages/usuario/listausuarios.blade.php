		...
		<div class="card-body p-4">
			<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
				...
				<div class="d-flex flex-wrap gap-3 align-items-center">
					<a href="{{ url('/agregar-usuario/' . $idopcion) }}" target="_self">
			...
			<div class="default-table-area all-products">
				<div class="table-responsive">
					<table class="table align-middle" id="myTable">
						...
						<tbody>
							@foreach($listausuarios as $index => $item)
								<tr>
									<td class="text-secondary">{{$item->nombre}}</td>
									<td class="text-secondary">{{$item->rol->nombre}}</td>
											...
											<ul class="dropdown-menu dropdown-menu-end">
												<li>
													...
													modificar-usuario-mto
														href="{{ url('/modificar-usuario/'.$idopcion.'/'.Hashids::encode(substr($item->id, -8))) }}">
