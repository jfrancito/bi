...
class AcopioPrecioUnitarioHumedoController extends Controller
{
    use UserTraits;

    public function actionListarPrecioUnitarioHumedo($idopcion)
    {
        /******************* validar url **********************/
        ...
        /******************************************************/
        View::share('titulo', 'Precio Unitario Húmedo');
    ...
    public function actionAjaxListarPrecioUnitarioHumedo(Request $request)
    {
        try {
            ...
            $query = DB::table('acopio_arroz_raw')
                ->select(
                    ...
                    DB::raw('MIN(precio_costo_recepcion_kg) as min_ph'),
                    DB::raw('MAX(precio_costo_recepcion_kg) as max_ph')
                )
    ...
    public function actionExportarDetallePrecioUnitario(Request $request)
    {
        $anio = $request->input('anio');
        $mes = $request->input('mes');
        ...
        $filename = "detalle_pu_humedo_" . date('Ymd_His') . ".csv";
        $headers = array(
